...
public interface UsesConstants {
  ...
  public static final String DEFAULT_CURRENCY = DEFAULT_CURRENCY_ENUM.value();
  ...
  public static final String DEFAULT_NAME_TYPE = DEFAULT_NAME_TYPE_ENUM.value();
  public static final String DEFAULT_ADDRESS_TYPE = "0123";
  public static final String DEFAULT_ADDRESS_ROLE = "012B";
}

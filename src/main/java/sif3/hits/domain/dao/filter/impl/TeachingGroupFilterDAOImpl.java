...
@Repository
public class TeachingGroupFilterDAOImpl extends BaseFilterableRepository<TeachingGroup, TeachingGroupType>
		implements TeachingGroupFilterDAO {
	...
	protected void addServicePathCriteria(Criteria criteria, String key, String value) {
		if ("StudentPersonals".equals(key)) {
			...
			teachingGroupQuery.add(Restrictions.eq("student." + CollectionPropertyNames.COLLECTION_ELEMENTS, value));
			...
			teachingGroupTeacherQuery.add(Restrictions.eq("teachingGroupTeacherId.staffPersonalRefId", value));

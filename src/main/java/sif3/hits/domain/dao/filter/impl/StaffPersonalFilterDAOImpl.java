...
@Repository
public class StaffPersonalFilterDAOImpl extends BaseFilterableRepository<StaffPersonal, StaffPersonalType> implements StaffPersonalFilterDAO {
    public StaffPersonalFilterDAOImpl() {
        super(StaffPersonal.class, StaffPersonalType.class);
    }

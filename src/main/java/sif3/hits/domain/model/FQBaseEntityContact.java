...
@MappedSuperclass
public abstract class FQBaseEntityContact extends HitsEntity {
    ...
    @Transient
    public abstract FQBaseEntityContactName getName();

    @Transient
    public abstract FQBaseEntityContactAddress getAddress();
}

...
public class StudentPersonal extends HitsEntity implements StudentPerson, AddressPerson {
	...
	private String prePrimaryEducation;
	private String prePrimaryEducationHours;
	...
	public String getPrePrimaryEducation() {
		return prePrimaryEducation;
	}

	public void setPrePrimaryEducation(String prePrimaryEducation) {
		this.prePrimaryEducation = prePrimaryEducation;
	}

	public String getPrePrimaryEducationHours() {
		return prePrimaryEducationHours;
	}

	public void setPrePrimaryEducationHours(String prePrimaryEducationHours) {
		this.prePrimaryEducationHours = prePrimaryEducationHours;
	}
}

...
@Component
public class FQEntityContactNameConverter extends HitsConverter<NameType, FQEntityContactName> {

    public FQEntityContactNameConverter() {
        super(NameType.class, FQEntityContactName.class);
    }

    @Override
    public NameType toSifModel(FQEntityContactName source) {
    ...
    @Override
    public void toSifModel(FQEntityContactName source, NameType target) {
    ...
    @Override
    public void toHitsModel(NameType source, FQEntityContactName target) {
    ...
    public boolean isPopulated(FQEntityContactName source) {

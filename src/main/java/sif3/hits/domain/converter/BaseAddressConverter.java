...
import sif3.hits.domain.model.BaseAddress;

public abstract class BaseAddressConverter<E extends BaseAddress>
		extends HitsConverter<AddressType, E> {

	public BaseAddressConverter(Class<E> modelClass) {
	...
	public static boolean isPopulated(BaseAddress source) {
	...
	private static boolean isStreetPopulated(BaseAddress source) {

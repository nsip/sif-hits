...
public class DebtorConverter extends HitsConverter<DebtorType, Debtor> {
  ...
  public void toSifModel(Debtor source, DebtorType target) {
    if (source != null && target != null) {
      ...
      if (StringUtils.isNotBlank(source.getBilledEntity())
          || StringUtils.isNotBlank(source.getBilledEntitySIFRefObject())) {
      ...
      target.setDiscount(objectFactory.createDebtorTypeDiscount(getBigDecimalValue(source.getDiscount())));
      ...
      if (source.getAddresses() != null && !source.getAddresses().isEmpty()) {
        ...
        addressList.getAddress()
            .addAll(addressConverter.toSifModelList(source.getAddresses(), AddressListType.Address.class));
  ...
  public void toHitsModel(DebtorType source, Debtor target) {
    if (source != null && target != null) {
      ...
      target.setDiscount(getBigDecimalValue(getJAXBValue(source.getDiscount())));

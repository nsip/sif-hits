...
public class NAPEventStudentLinkConverter extends HitsConverter<NAPEventStudentLinkType, NAPEventStudentLink> {
    ...
    public void toSifModel(NAPEventStudentLink source, NAPEventStudentLinkType target) {
        if (source != null && target != null) {
            ...
            target.setDate(objectFactory.createNAPEventStudentLinkTypeDate(getDateValue(source.getEventDate())));
            ...
            target.setLapsedTimeTest(objectFactory.createNAPEventStudentLinkTypeLapsedTimeTest(getDurationValue(source.getLapsedTimeTest())));
            ...
            target.setStartTime(objectFactory.createNAPEventStudentLinkTypeStartTime(getTimeValue(source.getStartTime())));
            ...
            if (schoolInfo != null) {
                ...
                target.setSchoolGeolocation(
                        objectFactory.createNAPEventStudentLinkTypeSchoolGeolocation(getEnumValue(schoolInfo.getAddressGeographicLocation(), AUCodeSetsSchoolLocationType.class)));
    ...
    public void toHitsModel(NAPEventStudentLinkType source, NAPEventStudentLink target) {
        if (source != null && target != null) {
            ...
            target.setEventDate(getDateValue(getJAXBValue(source.getDate())));
            target.setDevice(getJAXBValue(source.getDevice()));
            target.setDobRange(getBooleanValue(getJAXBValue(source.getDOBRange())));
            target.setLapsedTimeTest(getDurationValue(getJAXBValue(source.getLapsedTimeTest())));

...
@Component
public class AGAddressCollectionSubmissionEntityContactAddressConverter extends FQBaseEntityContactAddressConverter<AGAddressCollectionSubmissionEntityContactAddress> {

    @Autowired
    AGAddressCollectionSubmissionEntityContactAddressStatisticalAreaConverter statisticalAreaConverter;

    public AGAddressCollectionSubmissionEntityContactAddressConverter() {
        super(AGAddressCollectionSubmissionEntityContactAddress.class);
    }

    @Override
    public void toSifModel(AGAddressCollectionSubmissionEntityContactAddress source, AddressType target) {
        if (source != null && target != null) {
            ...
            if (source.getStatisticalAreas() != null) {
                ...
                for (AGAddressCollectionSubmissionEntityContactAddressStatisticalArea statisticalArea : source.getStatisticalAreas()) {
    ...
    @Override
    public void toHitsModel(AddressType source, AGAddressCollectionSubmissionEntityContactAddress target) {
        if (source != null && target != null) {
            ...
            if (statisticalAreasType != null) {
                for (StatisticalAreaType statisticalAreaType : statisticalAreasType.getStatisticalArea()) {
                    AGAddressCollectionSubmissionEntityContactAddressStatisticalArea statisticalArea = statisticalAreaConverter.toHitsModel(statisticalAreaType);

    ...
    public void toSifModel(StudentPersonal source, StudentPersonalType target) {
        if (source != null && target != null) {
            ...
            mostRecent.setParent1Language(objectFactory.createStudentMostRecentContainerTypeParent1Language(
                    getEnumValue(source.getMostRecentParent1Language(), AUCodeSetsAustralianStandardClassificationOfLanguagesASCLType.class)));
            mostRecent.setParent2Language(objectFactory.createStudentMostRecentContainerTypeParent2Language(
                    getEnumValue(source.getMostRecentParent2Language(), AUCodeSetsAustralianStandardClassificationOfLanguagesASCLType.class)));
            mostRecent.setParent1SchoolEducationLevel(objectFactory.createStudentMostRecentContainerTypeParent1SchoolEducationLevel(
                    getEnumValue(source.getMostRecentParent1SchoolEducation(), AUCodeSetsSchoolEducationLevelTypeType.class)));
            mostRecent.setParent2SchoolEducationLevel(objectFactory.createStudentMostRecentContainerTypeParent2SchoolEducationLevel(
                    getEnumValue(source.getMostRecentParent2SchoolEducation(), AUCodeSetsSchoolEducationLevelTypeType.class)));
            mostRecent.setParent1NonSchoolEducation(objectFactory.createStudentMostRecentContainerTypeParent1NonSchoolEducation(
                    getEnumValue(source.getMostRecentParent1NonSchoolEducation(), AUCodeSetsNonSchoolEducationType.class)));
            mostRecent.setParent2NonSchoolEducation(objectFactory.createStudentMostRecentContainerTypeParent2NonSchoolEducation(
                    getEnumValue(source.getMostRecentParent2NonSchoolEducation(), AUCodeSetsNonSchoolEducationType.class)));
            mostRecent.setParent1EmploymentType(objectFactory
                    .createStudentMostRecentContainerTypeParent1EmploymentType(getEnumValue(source.getMostRecentParent1EmploymentType(), AUCodeSetsEmploymentTypeType.class)));
            mostRecent.setParent2EmploymentType(objectFactory
                    .createStudentMostRecentContainerTypeParent2EmploymentType(getEnumValue(source.getMostRecentParent2EmploymentType(), AUCodeSetsEmploymentTypeType.class)));
            ...
            mostRecent.setMembershipType(
                    objectFactory.createStudentMostRecentContainerTypeMembershipType(getEnumValue(source.getMostRecentMembershipType(), AUCodeSetsSchoolEnrollmentTypeType.class)));
            mostRecent.setOtherEnrollmentSchoolACARAId(
                    objectFactory.createStudentMostRecentContainerTypeOtherEnrollmentSchoolACARAId(source.getMostRecentOtherEnrollmentSchoolAcaraId()));
            ...
            target.setHomeSchooledStudent(
                    objectFactory.createStudentPersonalTypeHomeSchooledStudent(getEnumValue(source.getHomeSchooledStudent(), AUCodeSetsYesOrNoCategoryType.class)));

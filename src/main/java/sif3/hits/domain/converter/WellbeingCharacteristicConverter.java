...
@Component
public class WellbeingCharacteristicConverter extends HitsConverter<WellbeingCharacteristicType, WellbeingCharacteristic> implements UsesConstants {
    ...
    public void toSifModel(WellbeingCharacteristic source, WellbeingCharacteristicType target) {
        if (source != null && target != null) {
            ...
            target.setSchoolInfoRefId(objectFactory.createWellbeingCharacteristicTypeSchoolInfoRefId(source.getSchoolInfoRefId()));
            target.setWellbeingCharacteristicClassification(objectFactory.createWellbeingCharacteristicTypeWellbeingCharacteristicClassification(
                    getEnumValue(source.getClassification(), AUCodeSetsWellbeingCharacteristicClassificationType.class)));
            target.setWellbeingCharacteristicStartDate(objectFactory.createWellbeingCharacteristicTypeWellbeingCharacteristicStartDate(getDateValue(source.getStartDate())));
            target.setWellbeingCharacteristicEndDate(objectFactory.createWellbeingCharacteristicTypeWellbeingCharacteristicEndDate(getDateValue(source.getEndDate())));
            target.setWellbeingCharacteristicReviewDate(objectFactory.createWellbeingCharacteristicTypeWellbeingCharacteristicReviewDate(getDateValue(source.getReviewDate())));
            target.setWellbeingCharacteristicNotes(objectFactory.createWellbeingCharacteristicTypeWellbeingCharacteristicNotes(source.getNotes()));
            target.setWellbeingCharacteristicCategory(objectFactory.createWellbeingCharacteristicTypeWellbeingCharacteristicCategory(source.getCategory()));
            target.setWellbeingCharacteristicSubCategory(objectFactory.createWellbeingCharacteristicTypeWellbeingCharacteristicSubCategory(source.getSubcategory()));
            target.setLocalCharacteristicCode(objectFactory.createWellbeingCharacteristicTypeLocalCharacteristicCode(source.getLocalCharacteristicCode()));
            target.setCharacteristicSeverity(objectFactory.createWellbeingCharacteristicTypeCharacteristicSeverity(source.getCharacteristicSeverity()));
            target.setDailyManagement(objectFactory.createWellbeingCharacteristicTypeDailyManagement(source.getDailyManagement()));
            target.setEmergencyManagement(objectFactory.createWellbeingCharacteristicTypeEmergencyManagement(source.getEmergencyManagement()));
            target.setEmergencyResponsePlan(objectFactory.createWellbeingCharacteristicTypeEmergencyResponsePlan(source.getEmergencyResponsePlan()));
            target.setTrigger(objectFactory.createWellbeingCharacteristicTypeTrigger(source.getTrigger()));
            target.setConfidentialFlag(
                    objectFactory.createWellbeingCharacteristicTypeConfidentialFlag(getEnumValue(source.getConfidentialFlag(), AUCodeSetsYesOrNoCategoryType.class)));
            target.setAlert(objectFactory.createWellbeingCharacteristicTypeAlert(getEnumValue(source.getAlert(), AUCodeSetsYesOrNoCategoryType.class)));
            ...
            if (source.getMedication() != null && !source.getMedication().isEmpty()) {
                ...
                if (medications != null && !medications.isEmpty()) {
                    ...
                    target.setMedicationList(objectFactory.createWellbeingCharacteristicTypeMedicationList(medicationList));
                }
            }
        }
    }
    ...
    public void toHitsModel(WellbeingCharacteristicType source, WellbeingCharacteristic target) {
        if (source != null && target != null) {
            ...
            if (documentList != null && !documentList.getDocument().isEmpty()) {
                List<WellbeingCharacteristicDocument> documents = documentConverter.toHitsModelList(documentList.getDocument());
                if (documents != null && !documents.isEmpty()) {
            ...
            if (medicationList != null && !medicationList.getMedication().isEmpty()) {
                List<WellbeingCharacteristicMedication> medications = medicationConverter.toHitsModelList(medicationList.getMedication());
                if (medications != null && !medications.isEmpty()) {

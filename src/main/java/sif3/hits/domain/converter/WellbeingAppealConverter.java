...
@Component
public class WellbeingAppealConverter extends HitsConverter<WellbeingAppealType, WellbeingAppeal> implements UsesConstants {
    ...
    public void toSifModel(WellbeingAppeal source, WellbeingAppealType target) {
        if (source != null && target != null) {
            ...
            target.setAppealStatusCode(objectFactory.createWellbeingAppealTypeAppealStatusCode(getEnumValue(source.getAppealStatusCode(), AUCodeSetsWellbeingAppealStatusType.class)));

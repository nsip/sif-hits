...
@Component
public class AGAddressCollectionSubmissionConverter extends HitsConverter<AGAddressCollectionSubmissionType, AGAddressCollectionSubmission> implements UsesConstants {

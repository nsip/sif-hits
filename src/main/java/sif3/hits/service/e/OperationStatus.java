...
public enum OperationStatus {
  ...
  CREATE_ERR_NO_ADVISORY(false, HttpStatus.NOT_ACCEPTABLE.value(), "No advisory id supplied and use advisory is true."), 
  CREATE_ERR_EXISTS(false, HttpStatus.CONFLICT.value(), "Object with that reference id already exists."), 
  ...
  UPDATE_ERR_REFID_MISMATCH(false, HttpStatus.NOT_ACCEPTABLE.value(), "Unable to update reference id."),
  UPDATE_ERR_NO_OBJECT(false, HttpStatus.NOT_FOUND.value(), "Object with that reference id not found."), 

...
public class PaymentReceiptConsumerTest extends BaseTest implements UsesConstants {
    ...
    public void setup() {
        ...
        paymentReceiptTester = new ConsumerTest<PaymentReceiptType, PaymentReceiptCollectionType>(PaymentReceiptType.class, "PaymentReceipt", PaymentReceiptCollectionType.class,
                "PaymentReceipts");

...
public class ScheduledActivityConsumerTest extends BaseTest<ScheduledActivityType, ScheduledActivityCollectionType> {
	...
	public void setup() {
		...
		scheduledActivityTester = new ConsumerTest<>(ScheduledActivityType.class, "ScheduledActivity",
	...
	@Override
	public void setRefId(ScheduledActivityType object, String refId) {
		object.setRefId(refId);
	}

	@Override
	public List<ScheduledActivityType> getCollectionList(ScheduledActivityCollectionType collection) {
		return Optional.ofNullable(collection).map(ScheduledActivityCollectionType::getScheduledActivity)

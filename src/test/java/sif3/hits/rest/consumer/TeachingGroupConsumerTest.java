...
public class TeachingGroupConsumerTest extends BaseTest {
    ...
    public void setup() {
        ...
        teachingGroupTester = new ConsumerTest<TeachingGroupType, TeachingGroupCollectionType>(TeachingGroupType.class, "TeachingGroup", TeachingGroupCollectionType.class,
                "TeachingGroups");
    ...
    public void testUpdateSingleTeachers() throws Exception {
        ...
        teachingGroup.getTeacherList().getValue().getTeachingGroupTeacher().get(0)
                .setStaffPersonalRefId(objectFactory.createTeachingGroupTeacherTypeStaffPersonalRefId(StaffPersonalRefIds.REF_ID_1));
        teachingGroupTester.doUpdateOne(teachingGroup, REF_ID);
        responses = teachingGroupTester.testGetSingle(REF_ID);
        Assert.assertNotNull(responses);
        Assert.assertEquals(1, responses.size());
    ...
    public void testUpdateSinglePeriods() throws Exception {
        ...
        Assert.assertEquals(TimeTableCellConsumerTest.REF_ID,
                teachingGroup.getTeachingGroupPeriodList().getValue().getTeachingGroupPeriod().get(0).getTimeTableCellRefId().getValue());
        ...
        Assert.assertNotNull(teachingGroup.getTeachingGroupPeriodList().getValue());
        Assert.assertEquals(1, teachingGroup.getTeachingGroupPeriodList().getValue().getTeachingGroupPeriod().size());
        Assert.assertEquals(TimeTableCellConsumerTest.REF_ID_OTHER,
                teachingGroup.getTeachingGroupPeriodList().getValue().getTeachingGroupPeriod().get(0).getTimeTableCellRefId().getValue());

        teachingGroup.getTeachingGroupPeriodList().getValue().getTeachingGroupPeriod().get(0)
                .setTimeTableCellRefId(objectFactory.createTeachingGroupPeriodTypeTimeTableCellRefId(TimeTableCellConsumerTest.REF_ID));
        teachingGroupTester.doUpdateOne(teachingGroup, REF_ID);
        responses = teachingGroupTester.testGetSingle(REF_ID);
        Assert.assertNotNull(responses);
        Assert.assertEquals(1, responses.size());

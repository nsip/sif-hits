...
public class StudentAttendanceSummaryConsumerTest extends BaseTest<StudentAttendanceSummaryType, StudentAttendanceSummaryCollectionType> {
    ...
    public void setup() {
        ...
        studentAttendanceSummaryTester = new ConsumerTest<>(StudentAttendanceSummaryType.class, "StudentAttendanceSummary", StudentAttendanceSummaryCollectionType.class, "StudentAttendanceSummarys");
    ...
    public List<StudentAttendanceSummaryType> getCollectionList(StudentAttendanceSummaryCollectionType collection) {
        return Optional.ofNullable(collection).map(StudentAttendanceSummaryCollectionType::getStudentAttendanceSummary).orElse(new ArrayList<>());
    }

    @Override
    public int getCollectionSize(StudentAttendanceSummaryCollectionType collection) {
        return Optional.ofNullable(collection).map(StudentAttendanceSummaryCollectionType::getStudentAttendanceSummary).map(List::size).orElse(-1);
    }

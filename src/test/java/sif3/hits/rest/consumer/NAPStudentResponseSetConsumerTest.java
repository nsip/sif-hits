...
public class NAPStudentResponseSetConsumerTest
		extends BaseTest<NAPStudentResponseSetType, NAPStudentResponseSetCollectionType> {
	...
	public void setup() {
		...
		nAPStudentResponseSetTester = new ConsumerTest<>(NAPStudentResponseSetType.class, "NAPStudentResponseSet",
	...
	@Override
	public void setRefId(NAPStudentResponseSetType object, String refId) {
	...
	public List<NAPStudentResponseSetType> getCollectionList(NAPStudentResponseSetCollectionType collection) {
		return Optional.ofNullable(collection).map(NAPStudentResponseSetCollectionType::getNAPStudentResponseSet)

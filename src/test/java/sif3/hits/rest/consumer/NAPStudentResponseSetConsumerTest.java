...
public class NAPStudentResponseSetConsumerTest extends BaseTest {
  ...
  public void initialiseData() throws Exception {
    ...
    napStudentResponseSetType.setPathTakenForDomain("A9-B0-C1-D1-E8-F6");
    ...
    napStudentResponseSetType.setDomainScore(getDomainScore());
    ...
    napStudentResponseSetType.setTestletList(napTestletListType);
  ...
  private NAPTestletResponseType getTestlet(String refId, String localId) {
    ...
    napTestletCommonType.setTestletSubScore(new BigDecimal("6"));
  ...
  private NAPTestletResponseItemType getNAPTestletItem(String refId, String localId, int index) {
    ...
    napTestletItemType.setNAPTestItemLocalId(objectFactory.createNAPTestletResponseItemTypeNAPTestItemLocalId(localId));
    napTestletItemType.setNAPTestItemRefId(refId);
    napTestletItemType.setResponse("ezSwZRTsWP" + index);
    napTestletItemType.setResponseCorrectness(objectFactory.createNAPTestletResponseItemTypeResponseCorrectness(AUCodeSetsNAPResponseCorrectnessType.CORRECT));
  ...
  private DomainScoreType getDomainScore() {
    ...
    domainScoreType.setStudentProficiency("Proficient");
  ...
  public void setup() {
    ...
    napStudentResponseSetTester = new ConsumerTest<NAPStudentResponseSetType, NAPStudentResponseSetCollectionType>(NAPStudentResponseSetType.class, "NAPStudentResponseSet", NAPStudentResponseSetCollectionType.class, "NAPStudentResponseSets");

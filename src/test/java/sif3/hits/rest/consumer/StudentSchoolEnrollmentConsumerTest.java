...
public class StudentSchoolEnrollmentConsumerTest extends BaseTest<StudentSchoolEnrollmentType, StudentSchoolEnrollmentCollectionType> {
    ...
    public void setup() {
        ...
        studentSchoolEnrollmentTester = new ConsumerTest<>(StudentSchoolEnrollmentType.class, "StudentSchoolEnrollment", StudentSchoolEnrollmentCollectionType.class, "StudentSchoolEnrollments");
    ...
    public List<StudentSchoolEnrollmentType> getCollectionList(StudentSchoolEnrollmentCollectionType collection) {
        return Optional.ofNullable(collection).map(StudentSchoolEnrollmentCollectionType::getStudentSchoolEnrollment).orElse(new ArrayList<>());
    }

    @Override
    public int getCollectionSize(StudentSchoolEnrollmentCollectionType collection) {
        return Optional.ofNullable(collection).map(StudentSchoolEnrollmentCollectionType::getStudentSchoolEnrollment).map(List::size).orElse(-1);
    }

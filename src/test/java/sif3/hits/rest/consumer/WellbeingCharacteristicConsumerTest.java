...
public class WellbeingCharacteristicConsumerTest extends BaseTest<WellbeingCharacteristicType, WellbeingCharacteristicCollectionType> {
    ...
    public void setup() {
        ...
        wellbeingCharacteristicTester = new ConsumerTest<>(WellbeingCharacteristicType.class, "WellbeingCharacteristic", WellbeingCharacteristicCollectionType.class, "WellbeingCharacteristics");
    ...
    public int getCollectionSize(WellbeingCharacteristicCollectionType collection) {
        return Optional.ofNullable(collection).map(WellbeingCharacteristicCollectionType::getWellbeingCharacteristic).map(List::size).orElse(-1);
    }

    @Override
    public List<WellbeingCharacteristicType> getCollectionList(WellbeingCharacteristicCollectionType collection) {
        return Optional.ofNullable(collection).map(WellbeingCharacteristicCollectionType::getWellbeingCharacteristic).orElse(new ArrayList<>());
    }

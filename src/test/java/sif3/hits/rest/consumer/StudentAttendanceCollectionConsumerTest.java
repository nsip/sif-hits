...
public class StudentAttendanceCollectionConsumerTest extends BaseTest<StudentAttendanceCollectionType, StudentAttendanceCollectionCollectionType> {
    ...
    public void setup() {
        ...
        studentAttendanceCollectionTester = new ConsumerTest<>(StudentAttendanceCollectionType.class, "StudentAttendanceCollection", StudentAttendanceCollectionCollectionType.class, "StudentAttendanceCollections");
    ...
    public int getCollectionSize(StudentAttendanceCollectionCollectionType collection) {
        return Optional.ofNullable(collection).map(StudentAttendanceCollectionCollectionType::getStudentAttendanceCollection).map(List::size).orElse(-1);
    }

    @Override
    public List<StudentAttendanceCollectionType> getCollectionList(StudentAttendanceCollectionCollectionType collection) {
        return Optional.ofNullable(collection).map(StudentAttendanceCollectionCollectionType::getStudentAttendanceCollection).orElse(new ArrayList<>());
    }

...
public class StudentContactRelationshipConsumerTest extends BaseTest<StudentContactRelationshipType, StudentContactRelationshipCollectionType> {
    ...
    public void setup() {
        ...
        studentContactRelationshipTester = new ConsumerTest<>(StudentContactRelationshipType.class, "StudentContactRelationship", StudentContactRelationshipCollectionType.class, "StudentContactRelationships");
    ...
    public List<StudentContactRelationshipType> getCollectionList(StudentContactRelationshipCollectionType collection) {
        return Optional.ofNullable(collection).map(StudentContactRelationshipCollectionType::getStudentContactRelationship).orElse(new ArrayList<>());
    }

    @Override
    public int getCollectionSize(StudentContactRelationshipCollectionType collection) {
        return Optional.ofNullable(collection).map(StudentContactRelationshipCollectionType::getStudentContactRelationship).map(List::size).orElse(-1);
    }

...
public class AddressCollectionConsumerTest extends BaseTest<AddressCollectionType, AddressCollectionCollectionType> {
	...
	public void setup() {
		...
		addressCollectionTester = new ConsumerTest<>(AddressCollectionType.class, "AddressCollection",
				AddressCollectionCollectionType.class, "AddressCollections");
	...
	@Override
	public void setRefId(AddressCollectionType object, String refId) {
		object.setRefId(refId);
	}

	@Override
	public int getCollectionSize(AddressCollectionCollectionType collection) {
		return Optional.ofNullable(collection).map(AddressCollectionCollectionType::getAddressCollection)

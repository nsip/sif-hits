...
public class ConsumerTests {
    public static Class<?>[] CONSUMER_CLASSES = new Class<?>[]{
            ...
            AddressCollectionConsumerTest.class,
            CensusCollectionConsumerTest.class,
            CollectionRoundConsumerTest.class,
            CollectionStatusConsumerTest.class,
            FinancialQuestionnaireCollectionConsumerTest.class,
            StudentAttendanceCollectionConsumerTest.class,
...
delete from LibraryPatronStatus_LocalCode;
delete from LibraryPatronStatus_Message;
delete from LibraryPatronStatus_Transaction_FineInfo;
delete from LibraryPatronStatus_Transaction_HoldInfo;
delete from LibraryPatronStatus_Transaction_Checkout;
delete from LibraryPatronStatus_Transaction_Item;
delete from LibraryPatronStatus_Transaction;
delete from LibraryPatronStatus_ElectronicId;
delete from LibraryPatronStatus_PatronName;
delete from LibraryPatronStatus;
delete from StudentAttendanceCR_YearLevel_StatsCohort;
delete from StudentAttendanceCR_StatsCohortYearLevel;
delete from StudentAttendanceCR_EntityContact_Address_StatisticalArea;
delete from StudentAttendanceCR_EntityContact_Address;
delete from StudentAttendanceCR_EntityContact_Name;
delete from StudentAttendanceCR_EntityContact;
delete from StudentAttendanceCollectionReporting;
delete from StudentAttendanceCollection_LocalCode;
delete from StudentAttendanceCollection;
delete from FQReporting_AGRule;
delete from FQReporting_FQItem;
delete from FQReporting_ContextualQuestion;
delete from FQReporting_EntityContact_Address_StatisticalArea;
delete from FQReporting_EntityContact_Address;
delete from FQReporting_EntityContact_Name;
delete from FQReporting_EntityContact;
delete from FQReporting;
delete from FQCollection_LocalCode;
delete from FinancialQuestionnaireCollection;
delete from CollectionStatus_AGROResponse_AGRule;
delete from CollectionStatus_AGReportingObjectResponse;
delete from CollectionStatus_LocalCode;
delete from CollectionStatus;
delete from AGRound;
delete from CollectionRound_LocalCode;
delete from CollectionRound;
delete from CensusReporting_Student;
delete from CensusReporting_Staff_ActivityOtherCode;
delete from CensusReporting_Staff;
delete from CensusReporting_EntityContact_Address_StatisticalArea;
delete from CensusReporting_EntityContact_Address;
delete from CensusReporting_EntityContact_Name;
delete from CensusReporting_EntityContact;
delete from CensusReporting;
delete from CensusCollection;
delete from AddressCR_Parent_Address_StatisticalArea;
delete from AddressCR_Parent_Address;
delete from AddressCR_Parent_Name;
delete from AddressCR_Parent;
delete from AddressCR_Student_Address_StatisticalArea;
delete from AddressCR_Student_Address;
delete from AddressCR_Student;
delete from AddressCR_EntityContact_Address_StatisticalArea;
delete from AddressCR_EntityContact_Address;
delete from AddressCR_EntityContact_Name;
delete from AddressCR_EntityContact;
delete from AddressCR_ContextualQuestion;
delete from AddressCollectionReporting;
delete from AddressCollection_LocalCode;
delete from AddressCollection;
delete from SchoolCourseInfo_SubjectArea_Code;
delete from SchoolCourseInfo_SubjectArea;
delete from SchoolCourseInfo;
delete from TermInfo;
delete from StudentScoreJAS_LearningStandard;
delete from StudentScoreJudgementAgainstStandard;
delete from WellbeingPersonLink_FollowupAction;
delete from WellbeingPersonLink;
delete from TimeTableCell_TeacherCover;
...
delete from WellbeingCharacteristic_Symptom;
...
delete from Invoice_AccountCode;
delete from Invoice;
...
delete from StaffAssignment_StaffSubject;
delete from StaffAssignment_CalendarSummary;
delete from StaffAssignment_YearLevel;
delete from StaffAssignment;
delete from Address;
delete from StaffPersonal_OtherId;
delete from StaffPersonal;
delete from StudentSchoolEnrollment_StudentSubjectChoice;
delete from StudentSchoolEnrollment_StudentGroup;
delete from StudentSchoolEnrollment_PublishingPermission;

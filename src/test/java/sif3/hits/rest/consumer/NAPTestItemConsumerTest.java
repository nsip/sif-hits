...
public class NAPTestItemConsumerTest extends BaseTest<NAPTestItemType, NAPTestItemCollectionType> {
    ...
    public void setup() {
        ...
        nAPTestItemTester = new ConsumerTest<>(NAPTestItemType.class, "NAPTestItem", NAPTestItemCollectionType.class, "NAPTestItems");
    ...
    public int getCollectionSize(NAPTestItemCollectionType collection) {
        return Optional.ofNullable(collection).map(NAPTestItemCollectionType::getNAPTestItem).map(List::size).orElse(-1);
    }

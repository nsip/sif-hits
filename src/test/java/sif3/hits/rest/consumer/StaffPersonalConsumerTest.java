...
public class StaffPersonalConsumerTest extends BaseTest {
  ...
  public void setup() {
    ...
    staffTester = new ConsumerTest<StaffPersonalType, StaffPersonalCollectionType>(StaffPersonalType.class, "StaffPersonal", StaffPersonalCollectionType.class, "StaffPersonals");

...
public class PaymentReceiptTestData extends TestData<PaymentReceiptType, PaymentReceiptCollectionType> {
    ...
    public PaymentReceiptType getTestObject(String refId) {
        ...
        paymentReceiptType.setChargedLocationInfoRefId(objectFactory.createPaymentReceiptTypeChargedLocationInfoRefId(ChargedLocationInfoTestData.REF_ID_1));
        ...
        paymentReceiptType.setInvoiceRefId(objectFactory.createPaymentReceiptTypeInvoiceRefId(InvoiceTestData.REF_ID_1));
        ...
        paymentReceiptType.setTransactionDescription(objectFactory.createPaymentReceiptTypeTransactionDescription(DESCRIPTION));
        ...
        paymentReceiptType.setVendorInfoRefId(objectFactory.createPaymentReceiptTypeVendorInfoRefId(VendorInfoTestData.REF_ID_1));

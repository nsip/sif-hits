...
public class VendorInfoTestData extends TestData<VendorInfoType, VendorInfoCollectionType> {
	...
	public VendorInfoType getTestObject(String refId) {
		...
		vendorInfoType.setLocalId(objectFactory.createVendorInfoTypeLocalId("local-id"));
		...
		contactInfoType
				.setRegistrationDetails(objectFactory.createContactInfoTypeRegistrationDetails("Registration Details"));
		...
		vendorInfoType.setRegisteredForGST(
				objectFactory.createVendorInfoTypeRegisteredForGST(AUCodeSetsYesOrNoCategoryType.Y));

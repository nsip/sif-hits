...
public class JournalTestData extends TestData<JournalType, JournalCollectionType> {
    ...
    public boolean isServicePathObject(JournalType object, int index) {
        // link to school is via account and then via charged location info no way to really check if it's the right school this way.
        return object != null && (object.getCreditFinancialAccountRefId() != null || object.getDebitFinancialAccountRefId() != null);
    }

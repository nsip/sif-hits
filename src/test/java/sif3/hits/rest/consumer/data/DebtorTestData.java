...
public class DebtorTestData extends TestData<DebtorType, DebtorCollectionType> {
    ...
    public boolean isExampleObject(DebtorType object, int index) {
        return object != null && object.getBilledEntity() != null && BILLED_ENTITY.equals(object.getBilledEntity().getSIFRefObject()) && VendorInfoTestData.REF_ID_1.equals(object.getBilledEntity().getValue());
    }

...
public class LibraryPatronStatusConsumerTest extends BaseTest<LibraryPatronStatusType, LibraryPatronStatusCollectionType> {
    ...
    public void setup() {
        ...
        libraryPatronStatusTester = new ConsumerTest<>(LibraryPatronStatusType.class, "LibraryPatronStatus", LibraryPatronStatusCollectionType.class, "LibraryPatronStatuss");
    ...
    public int getCollectionSize(LibraryPatronStatusCollectionType collection) {
        return Optional.ofNullable(collection).map(LibraryPatronStatusCollectionType::getLibraryPatronStatus).map(List::size).orElse(-1);
    }

    @Override
    public List<LibraryPatronStatusType> getCollectionList(LibraryPatronStatusCollectionType collection) {
        return Optional.ofNullable(collection).map(LibraryPatronStatusCollectionType::getLibraryPatronStatus).orElse(new ArrayList<>());
    }

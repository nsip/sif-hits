...
public class VendorInfoConsumerTest extends BaseTest<VendorInfoType, VendorInfoCollectionType> {
	...
	public void setup() {
		...
		vendorInfoTester = new ConsumerTest<>(VendorInfoType.class, "VendorInfo", VendorInfoCollectionType.class,
				"VendorInfos");
	...
	@Override
	public void setRefId(VendorInfoType object, String refId) {

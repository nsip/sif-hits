...
public class PersonPictureConsumerTest extends BaseTest {
  ...
  public void setup() {
    ...
    personPictureTester = new ConsumerTest<PersonPictureType, PersonPictureCollectionType>(PersonPictureType.class, "PersonPicture", PersonPictureCollectionType.class, "PersonPictures");

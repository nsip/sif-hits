...
public class PurchaseOrderConsumerTest extends BaseTest implements UsesConstants {
    ...
    private PurchasingItemType getPurchasingItem(ObjectFactory objectFactory, String amount, String description, String itemNumber, String quantity, String delivered,
            String unitCost) {
    ...
    public void setup() {
        ...
        purchaseOrderTester = new ConsumerTest<PurchaseOrderType, PurchaseOrderCollectionType>(PurchaseOrderType.class, "PurchaseOrder", PurchaseOrderCollectionType.class,
                "PurchaseOrders");

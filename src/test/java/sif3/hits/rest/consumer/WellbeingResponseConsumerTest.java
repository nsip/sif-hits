...
public class WellbeingResponseConsumerTest extends BaseTest<WellbeingResponseType, WellbeingResponseCollectionType> {
	...
	public void setup() {
		...
		wellbeingResponseTester = new ConsumerTest<>(WellbeingResponseType.class, "WellbeingResponse",
	...
	@Override
	public void setRefId(WellbeingResponseType object, String refId) {
		object.setRefId(refId);
	}

	@Override
	public int getCollectionSize(WellbeingResponseCollectionType collection) {
		return Optional.ofNullable(collection).map(WellbeingResponseCollectionType::getWellbeingResponse)

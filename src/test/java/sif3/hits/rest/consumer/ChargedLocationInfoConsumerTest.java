...
public class ChargedLocationInfoConsumerTest
		extends BaseTest<ChargedLocationInfoType, ChargedLocationInfoCollectionType> {
	...
	public void setup() {
		...
		chargedLocationInfoTester = new ConsumerTest<>(ChargedLocationInfoType.class, "ChargedLocationInfo",
				ChargedLocationInfoCollectionType.class, "ChargedLocationInfos");
	...
	@Override
	public void setRefId(ChargedLocationInfoType object, String refId) {
		object.setRefId(refId);
	}

	@Override
	public List<ChargedLocationInfoType> getCollectionList(ChargedLocationInfoCollectionType collection) {
		return Optional.ofNullable(collection).map(ChargedLocationInfoCollectionType::getChargedLocationInfo)

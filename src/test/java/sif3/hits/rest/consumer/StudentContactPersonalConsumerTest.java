...
public class StudentContactPersonalConsumerTest extends BaseTest<StudentContactPersonalType, StudentContactPersonalCollectionType> {
    ...
    public void setup() {
        ...
        studentContactPersonalTester = new ConsumerTest<>(StudentContactPersonalType.class, "StudentContactPersonal", StudentContactPersonalCollectionType.class, "StudentContactPersonals");
    ...
    public List<StudentContactPersonalType> getCollectionList(StudentContactPersonalCollectionType collection) {
        return Optional.ofNullable(collection).map(StudentContactPersonalCollectionType::getStudentContactPersonal).orElse(new ArrayList<>());
    }

    @Override
    public int getCollectionSize(StudentContactPersonalCollectionType collection) {
        return Optional.ofNullable(collection).map(StudentContactPersonalCollectionType::getStudentContactPersonal).map(List::size).orElse(-1);
    }

...
public class StudentScoreJudgementAgainstStandardConsumerTest
		extends BaseTest<StudentScoreJudgementAgainstStandardType, StudentScoreJudgementAgainstStandardCollectionType> {
	...
	public void setup() {
		...
		studentScoreJudgementAgainstStandardTester = new ConsumerTest<>(StudentScoreJudgementAgainstStandardType.class,
				"StudentScoreJudgementAgainstStandard", StudentScoreJudgementAgainstStandardCollectionType.class,
				"StudentScoreJudgementAgainstStandards");
	...
	@Override
	public void setRefId(StudentScoreJudgementAgainstStandardType object, String refId) {
	...
	public int getCollectionSize(StudentScoreJudgementAgainstStandardCollectionType collection) {
		return Optional.ofNullable(collection)
				.map(StudentScoreJudgementAgainstStandardCollectionType::getStudentScoreJudgementAgainstStandard)
				.map(List::size).orElse(-1);
	}

	@Override
	public List<StudentScoreJudgementAgainstStandardType> getCollectionList(
			StudentScoreJudgementAgainstStandardCollectionType collection) {
		return Optional.ofNullable(collection)
				.map(StudentScoreJudgementAgainstStandardCollectionType::getStudentScoreJudgementAgainstStandard)

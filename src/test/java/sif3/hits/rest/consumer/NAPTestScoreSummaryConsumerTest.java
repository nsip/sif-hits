...
public class NAPTestScoreSummaryConsumerTest
		extends BaseTest<NAPTestScoreSummaryType, NAPTestScoreSummaryCollectionType> {
	...
	public void setup() {
		...
		napTestScoreSummaryTester = new ConsumerTest<>(NAPTestScoreSummaryType.class, "NAPTestScoreSummary",
	...
	@Override
	public void setRefId(NAPTestScoreSummaryType object, String refId) {
		object.setRefId(refId);
	}

	@Override
	public int getCollectionSize(NAPTestScoreSummaryCollectionType collection) {
		return Optional.ofNullable(collection).map(NAPTestScoreSummaryCollectionType::getNAPTestScoreSummary)

...
public class InvoiceConsumerTest extends BaseTest implements UsesConstants {
    ...
    public void initialiseData() throws Exception {
        ...
        invoiceType.setFormNumber(objectFactory.createInvoiceTypeFormNumber("123"));
        ...
        invoiceType.setFormNumber(objectFactory.createInvoiceTypeFormNumber("TestQBE"));
        invoiceTester.doCreateOne(invoiceType);
    ...
    public void testQBEFormNumber() {
        ...
        InvoiceType invoiceType = new InvoiceType();
        invoiceType.setFormNumber(objectFactory.createInvoiceTypeFormNumber("TestQBE"));
        List<Response> responses = invoiceTester.testQBE(invoiceType, 10, 1);
        Assert.assertNotNull(responses);
        Assert.assertEquals(1, responses.size());
        Response response = responses.get(0);
        Assert.assertNotNull(response.getDataObject());
        ...
        Assert.assertEquals(1, invoiceCollection.getInvoice().size());
        InvoiceType invoice = invoiceCollection.getInvoice().get(0);
        Assert.assertEquals(InvoiceRefIds.REF_ID_5, invoice.getRefId());
    }

...
public class TestConsumer<S, M> extends AbstractEventConsumer<S> {
	...
	@Override
	public SIFEvent<S> createEventObject(Object sifObjectList, HeaderValues.EventAction eventAction,
			HeaderValues.UpdateType updateType) {
		return null;
	}
	...
	@Override
	public void processDelayedCreateMany(MultiOperationStatusList<CreateOperationStatus> arg0,
			DelayedResponseReceipt arg1) {
	...
	@Override
	public void processDelayedServicePath(Object arg0, QueryCriteria arg1, PagingInfo arg2,
			DelayedResponseReceipt arg3) {

...
public class StudentPersonalConsumerTest {
  ...
  public void setup() {
    ...
    studentTester = new ConsumerTest<StudentPersonalType, StudentCollectionType>(
        StudentPersonalType.class, "StudentPersonal", StudentCollectionType.class, "StudentPersonals");
    studentTester.testDeleteMany(REF_IDS);
  }
  
  @Test
  public void testGetSingle() {
    final String REF_ID = "236C3EE4-C43F-11E3-A7FB-E1F4DBD909AB";
    List<Response> responses = studentTester.testGetSingle(REF_ID);
    Assert.assertNotNull(responses);
    Assert.assertEquals(1, responses.size());
    Response response = responses.get(0);
    Assert.assertNotNull(response.getDataObject());
    StudentPersonalType studentPersonal = (StudentPersonalType) response.getDataObject();
    Assert.assertEquals(REF_ID, studentPersonal.getRefId());
  }

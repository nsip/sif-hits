...
public class WellbeingPersonLinkConsumerTest
		extends BaseTest<WellbeingPersonLinkType, WellbeingPersonLinkCollectionType> {
	...
	public void setup() {
		...
		wellbeingPersonLinkTester = new ConsumerTest<>(WellbeingPersonLinkType.class, "WellbeingPersonLink",
				WellbeingPersonLinkCollectionType.class, "WellbeingPersonLinks");
	...
	@Override
	public void setRefId(WellbeingPersonLinkType object, String refId) {
		object.setRefId(refId);
	}

	@Override
	public int getCollectionSize(WellbeingPersonLinkCollectionType collection) {
		return Optional.ofNullable(collection).map(WellbeingPersonLinkCollectionType::getWellbeingPersonLink)

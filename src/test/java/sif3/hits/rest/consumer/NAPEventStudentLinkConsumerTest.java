...
public class NAPEventStudentLinkConsumerTest extends BaseTest {
    ...
    public void setup() {
        ...
        napEventStudentLinkTester = new ConsumerTest<NAPEventStudentLinkType, NAPEventStudentLinkCollectionType>(NAPEventStudentLinkType.class, "NAPEventStudentLink",

...
public class StudentPeriodAttendanceConsumerTest extends BaseTest {
    ...
    public void initialiseData() throws Exception {
        ...
        studentPeriodAttendance.setSessionInfoRefId(objectFactory.createStudentPeriodAttendanceTypeSessionInfoRefId(SessionInfoConsumerTest.REF_ID));
    ...
    public void setup() {
        ...
        studentPeriodAttendanceTester = new ConsumerTest<StudentPeriodAttendanceType, StudentPeriodAttendanceCollectionType>(StudentPeriodAttendanceType.class,
                "StudentPeriodAttendance", StudentPeriodAttendanceCollectionType.class, "StudentPeriodAttendances");

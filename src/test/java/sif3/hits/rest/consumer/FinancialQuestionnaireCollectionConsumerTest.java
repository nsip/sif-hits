...
public class FinancialQuestionnaireCollectionConsumerTest
		extends BaseTest<FinancialQuestionnaireCollectionType, FinancialQuestionnaireCollectionCollectionType> {
	...
	public void setup() {
		...
		financialQuestionnaireTester = new ConsumerTest<>(FinancialQuestionnaireCollectionType.class,
				"FinancialQuestionnaireCollection", FinancialQuestionnaireCollectionCollectionType.class,
				"FinancialQuestionnaireCollections");
	...
	@Override
	public void setRefId(FinancialQuestionnaireCollectionType object, String refId) {
	...
	public int getCollectionSize(FinancialQuestionnaireCollectionCollectionType collection) {
		return Optional.ofNullable(collection)
				.map(FinancialQuestionnaireCollectionCollectionType::getFinancialQuestionnaireCollection)
				.map(List::size).orElse(-1);
	}

	@Override
	public List<FinancialQuestionnaireCollectionType> getCollectionList(
			FinancialQuestionnaireCollectionCollectionType collection) {
		return Optional.ofNullable(collection)
				.map(FinancialQuestionnaireCollectionCollectionType::getFinancialQuestionnaireCollection)

...
public class GradingAssignmentScoreConsumerTest extends BaseTest<GradingAssignmentScoreType, GradingAssignmentScoreCollectionType> {
    ...
    public void setup() {
        ...
        gradingAssignmentScoreTester = new ConsumerTest<>(GradingAssignmentScoreType.class, "GradingAssignmentScore", GradingAssignmentScoreCollectionType.class, "GradingAssignmentScores");
    ...
    public List<GradingAssignmentScoreType> getCollectionList(GradingAssignmentScoreCollectionType collection) {
        return Optional.ofNullable(collection).map(GradingAssignmentScoreCollectionType::getGradingAssignmentScore).orElse(new ArrayList<>());
    }

    @Override
    public int getCollectionSize(GradingAssignmentScoreCollectionType collection) {
        return Optional.ofNullable(collection).map(GradingAssignmentScoreCollectionType::getGradingAssignmentScore).map(List::size).orElse(-1);
    }

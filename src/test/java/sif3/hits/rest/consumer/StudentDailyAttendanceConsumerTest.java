...
public class StudentDailyAttendanceConsumerTest extends BaseTest<StudentDailyAttendanceType, StudentDailyAttendanceCollectionType> {
    ...
    public void setup() {
        ...
        studentDailyAttendanceTester = new ConsumerTest<>(StudentDailyAttendanceType.class, "StudentDailyAttendance", StudentDailyAttendanceCollectionType.class, "StudentDailyAttendances");
    ...
    public List<StudentDailyAttendanceType> getCollectionList(StudentDailyAttendanceCollectionType collection) {
        return Optional.ofNullable(collection).map(StudentDailyAttendanceCollectionType::getStudentDailyAttendance).orElse(new ArrayList<>());
    }

    @Override
    public int getCollectionSize(StudentDailyAttendanceCollectionType collection) {
        return Optional.ofNullable(collection).map(StudentDailyAttendanceCollectionType::getStudentDailyAttendance).map(List::size).orElse(-1);
    }
